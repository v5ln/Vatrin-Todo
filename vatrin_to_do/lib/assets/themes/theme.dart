  ...
  final ThemeData myTheme = ThemeData(
    ...
    toggleableActiveColor: const Color( 0xff5c6983 ),
    secondaryHeaderColor: const Color( 0xff616161 ),
    backgroundColor: const Color( 0xff616161 ),
    dialogBackgroundColor: const Color( 0xff424242 ),
    indicatorColor: const Color( 0xff446280 ),
 ...
 ,
    ...
    ), textSelectionTheme: const TextSelectionThemeData(cursorColor: Color( 0xff4285f4 ), selectionColor: Color( 0xff4c627e ), selectionHandleColor: Color( 0xff1d4761 ),),
  );
